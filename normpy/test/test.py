...
def test_edgeR():
    ...
    sys.stderr.write("Test edgeR done!\n")
...
def test_deseq():
    ...
    print("Normalized counts: ")
    print(norm_counts_df.head())
    sys.stderr.write("Test deseq done!\n")
...
def test_lowess():
    ...
    sys.stderr.write("Test lowess done!\n")
...
def R_test_lowess():
    ...
    sys.stderr.write("Test R lowess done!\n")
...
def test_quantile():
    ...
    print("Normalized counts: ")
    print(norm_counts_df.head())
    sys.stderr.write("Test quantile done!\n")
